...
def Signup(): # This is the signup definition,
    ...
    intruction.grid(row=0, columnspan=3, sticky=E) # This just puts it in the window, on row 0, col 0. If you want to learn more look up a tkinter tutorial :)
...
def CheckLogin():
    ...
    if nameEL.get() == uname and pwordEL.get() == pword: # Checks to see if you entered the correct data.
        ...
        rlbl.pack()
        continue_Button = Button(r, text = "Continue into app", command = to_Main_window)
...
def to_Main_window(): # I set r to be global in CheckLogin(), and made the button call this function
    r.destroy()
